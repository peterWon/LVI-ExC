...
bool GlobalSFM::solveFrameByPnP(
	...
	if (int(pts_2_vector.size()) < 15){
      ...
      LOG(INFO)<<"Unstable features tracking, please slowly move your device!"
               <<" Current feature size is "<<pts_2_vector.size();
      return false;
    }
	}
...
bool GlobalSFM::construct(int frame_num, Quaterniond* q, Vector3d* T, int l,
	...
	for (int i = 0; i < feature_num; i++){
        ...
        sfm_f[i].observation[j].second.y());
          ...
          NULL, c_rotation[l], c_translation[l], sfm_f[i].position);	 
		}
	}
    ...
    LOG(ERROR)<<"SFM does not converge!";
		return false;
	}
	for (int i = 0; i < frame_num; i++){
